...
public class GroundTiles : MonoBehaviour
{
    ...
    void CreateTiles()
    {
        ...
        //Transform mod = ceiling.GetComponent<Transform>();
        //mod.localScale = new Vector3(ceilingLength, 0, 0);
        //GameObject.Instantiate(ceiling, mod);
        ...
        for (int j = 0; j <= width; j++)
        {
            ...
            if(solidGround[rNumber].CompareTag("Green"))
            {
                ...
                position = new Vector3((offsetCube*7) + 4, 3.49f, 0);
